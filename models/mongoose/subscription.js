...
class SubscriptionModel extends BaseSubscriptionModel{
    ...
    async updateSubscription(subscription) {
        const dbSubscription = await this.model.findOne({ company_id: subscription.company_id, platform_subscription_id: new ObjectId(subscription.platform_subscription_id) });
